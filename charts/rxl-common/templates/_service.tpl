...
{{- define "rxl-common.service" }}
apiVersion: v1
kind: Service
metadata:
  name: {{ default (include "rxl-common.fullname" $) .Values.service.name }}
  labels:
...
spec:
  ...
  ports:
    {{- include "rxl-common.servicePorts" $ | nindent 4 }}
  ...
  selector:
    {{- include "rxl-common.selectorLabels" $ | nindent 4 }}
{{- end }}
...
*/}}
{{- define "rxl-common.servicePorts" -}}
